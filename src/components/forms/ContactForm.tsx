  ...
  return (
    <>
      <form
        ...
        ref={formRef}
      >
        <Input color='primary' type='text' label='Nombre' min={6} max={128} required />
        <Input color='primary' type='email' label='Correo electrónico' min={8} max={128} required />
        <Textarea color='primary' placeholder='Cuéntanos acerca de tu proyecto' min={6} max={512} required />
